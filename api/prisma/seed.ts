...
async function addFixtureCompany() {
	...
	await prisma.$transaction(async (tx) => {
		...
		const stockMovements = [
			{ id: IDS.movements.espresso, productId: IDS.products.espresso, quantityDelta: "48", idempotencyKey: "ui-fixture-stock-in-espresso" },
			{ id: IDS.movements.coldBrew, productId: IDS.products.coldBrew, quantityDelta: "21", idempotencyKey: "ui-fixture-stock-in-cold-brew" },
			{ id: IDS.movements.chips, productId: IDS.products.chips, quantityDelta: "74", idempotencyKey: "ui-fixture-stock-in-chips" },
			{ id: IDS.movements.cookies, productId: IDS.products.cookies, quantityDelta: "33", idempotencyKey: "ui-fixture-stock-in-cookies" },
		] as const;
		...
		const modifierOptions = [
			{ id: IDS.modifierOptions.oatMilk, modifierGroupId: IDS.modifiers.milkChoice, name: "Oat Milk", priceDeltaMinor: BigInt(1500), sortOrder: 1 },
			{ id: IDS.modifierOptions.soyMilk, modifierGroupId: IDS.modifiers.milkChoice, name: "Soy Milk", priceDeltaMinor: BigInt(1200), sortOrder: 2 },
			{ id: IDS.modifierOptions.wholeMilk, modifierGroupId: IDS.modifiers.milkChoice, name: "Whole Milk", priceDeltaMinor: BigInt(0), sortOrder: 3 },
			{ id: IDS.modifierOptions.singleShot, modifierGroupId: IDS.modifiers.extraShots, name: "+1 Shot", priceDeltaMinor: BigInt(2000), sortOrder: 1 },
			{ id: IDS.modifierOptions.doubleShot, modifierGroupId: IDS.modifiers.extraShots, name: "+2 Shots", priceDeltaMinor: BigInt(3800), sortOrder: 2 },
			{ id: IDS.modifierOptions.tripleShot, modifierGroupId: IDS.modifiers.extraShots, name: "+3 Shots", priceDeltaMinor: BigInt(5400), sortOrder: 3 },
			{ id: IDS.modifierOptions.caramel, modifierGroupId: IDS.modifiers.toppings, name: "Caramel Drizzle", priceDeltaMinor: BigInt(1000), sortOrder: 1 },
			{ id: IDS.modifierOptions.cocoa, modifierGroupId: IDS.modifiers.toppings, name: "Cocoa Dust", priceDeltaMinor: BigInt(800), sortOrder: 2 },
			{ id: IDS.modifierOptions.whippedCream, modifierGroupId: IDS.modifiers.toppings, name: "Whipped Cream", priceDeltaMinor: BigInt(1200), sortOrder: 3 },
			{ id: IDS.modifierOptions.homeVisit, modifierGroupId: IDS.modifiers.serviceAddOns, name: "Home Visit", priceDeltaMinor: BigInt(5000), sortOrder: 1 },
			{ id: IDS.modifierOptions.expressLane, modifierGroupId: IDS.modifiers.serviceAddOns, name: "Express Lane", priceDeltaMinor: BigInt(3500), sortOrder: 2 },
			{ id: IDS.modifierOptions.priorityBooking, modifierGroupId: IDS.modifiers.serviceAddOns, name: "Priority Booking", priceDeltaMinor: BigInt(2500), sortOrder: 3 },
		] as const;
