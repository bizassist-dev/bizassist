// BizAssist_mobile
// path: src/modules/discounts/screens/InventoryDiscountDetailScreen.tsx
//
// Header governance:
// - Discount details is an Inventory detail screen -> use BACK.
...
import {
	buildInventoryDiscountEditRoute,
...
export default function InventoryDiscountDetailScreen() {
	...
	const onBack = useCallback(() => {
		...
		const fallback = resolveInventoryDiscountDetailBackFallbackRoute(returnTo);
	...
	const onEdit = useCallback(() => {
		...
		const route = buildInventoryDiscountEditRoute(discount.id, returnTo);
